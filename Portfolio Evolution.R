...
setwd('c:/Set/Work/Directory')

cat("\f")  

#IMPORT DEGIRO PORTFOLIO CSV
#Link to Degiro CSV...
CSV_Link <- readClipboard()  #IMPORTANT: you must be logged in Degiro
...
#Putting all toghether and cleaning data  
